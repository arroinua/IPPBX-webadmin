	...
	render: function () {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement('div', { id: 'chatstat-date-picker', style: { display: "inline-block" }, className: 'cdropdown custom-dropdown' })
			),
			React.createElement(
				PanelComponent,
				null,
...
var NewPaymentMethodComponent = React.createClass({
	displayName: "NewPaymentMethodComponent",
	...
	render: function () {
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					"form",
					{ className: "form-horizontal", onSubmit: this._submitForm },
					React.createElement(
						"section",
						null,
						React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"label",
								{ className: "col-sm-4 control-label", htmlFor: "name-element" },
								"Name"
							),
							React.createElement(
								"div",
						...
						React.createElement(
							...
							React.createElement(
								"label",
								{ className: "col-sm-4 control-label", htmlFor: "email-element" },
								"Email"
							),
							React.createElement(
								"div",
						...
						React.createElement(
							...
							React.createElement(
								"label",
								{ className: "col-sm-4 control-label", htmlFor: "address-element" },
								"Address"
							),
							React.createElement(
								"div",
								{ className: "col-sm-6" },
								React.createElement("input", { className: "form-control", name: "address" })
							)
						),
						React.createElement(
							"div",
							...
							React.createElement(
								"label",
								{ className: "col-sm-4 control-label", htmlFor: "city-element" },
								"City"
							),
							React.createElement(
								"div",
								{ className: "col-sm-6" },
								React.createElement("input", { className: "form-control", name: "city" })
							)
						),
						React.createElement(
							"div",
							...
							React.createElement(
								"label",
								{ className: "col-sm-4 control-label", htmlFor: "postal-element" },
								"Postal code"
							),
							React.createElement(
								"div",
								{ className: "col-sm-6" },
								React.createElement("input", { className: "form-control", name: "postal" })
							)
						),
						React.createElement(
							"div",
							...
							React.createElement(
								"label",
								{ className: "col-sm-4 control-label", htmlFor: "country-element" },
								"Country"
							),
							React.createElement(
								"div",
								{ className: "col-sm-6" },
								React.createElement("select", { className: "form-control", name: "country" })
							)
						)
					),
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								"label",
								{ className: "col-sm-4 control-label", htmlFor: "card-element" },
								"Credit or debit card"
							),
							React.createElement("div", { className: "col-sm-6", id: "card-element", ref: this._onRef })
						)
					),
					React.createElement(
						"div",
...
function ManagePaymentMethodComponent(props) {
	...
	return React.createElement(
		...
		) : React.createElement(NewPaymentMethodComponent, { frases: frases, paymentMethod: paymentMethod, profile: profile })
	);
}
		...
		return React.createElement(
			...
			this.state.fetching ? React.createElement(Spinner, null) : React.createElement(
				...
				this.state.selectedTrunk ? React.createElement(
					"div",
					{ className: "form-group " + (this.props.validationError && !this.state.phoneNumber ? 'has-error' : '') },
					React.createElement(
						"label",
					...
					this.props.isNew ? React.createElement(
						...
						this.state.fetchingCountries ? React.createElement(Spinner, null) : React.createElement(
							...
							this.state.limitReached ? React.createElement(
								...
								'div',
								{ className: "form-group " + this._validateField(selectedCountry.id) },
								React.createElement(
									'label',
						...
						selectedCountry.id && React.createElement(
							...
							this.state.needRegion && React.createElement(
								'div',
								{ className: "form-group " + this._validateField(selectedRegion.id) },
								React.createElement(
									'label',
							...
							(!this.state.needRegion || selectedRegion.id) && React.createElement(
								'div',
								{ className: "form-group " + this._validateField(selectedLocation.id) },
								React.createElement(
									'label',
									{ htmlFor: 'location', className: 'col-sm-4 control-label' },
							...
							selectedLocation.id && React.createElement(
								'div',
								{ className: "form-group " + this._validateField(selectedAvailableNumber.id) },
								React.createElement(
									'label',
