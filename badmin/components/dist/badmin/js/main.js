...
function load_customers(params) {
    ...
    var availableServices = filterServices(importServices);
    ...
    function importCustomers(params) {
        ...
        json_rpc_async(method, params, function(result, error) {
            console.log('importCustomers result: ', result, error);
            if(!error) getCustomers();
        });
    }
...
function renderSidebar(params) {
	...
	function _getMenuObjects(menu, branchOptions, callback) {
		...
		if(menu.fetchKinds && menu.fetchKinds.length) {
			...
			switch(menu.name) {
				case 'dashboard':
					objects = [{ kind: 'dashboard', iconClass: 'fa fa-fw fa-tachometer' }, { kind: 'realtime', iconClass: 'fa fa-fw fa-heart' }, { kind: 'extensions', iconClass: 'fa fa-fw fa-users' }, { kind: 'statistics', iconClass: 'fa fa-fw fa-table' }, { kind: 'channel_statistics', iconClass: 'fa fa-fw fa-area-chart' }, { kind: 'records', iconClass: 'fa fa-fw fa-phone' }, { kind: 'reg_history', iconClass: 'fa fa-fw fa-history' }];
					break;
				case 'settings':
	...
	function _getActiveKind(kind) {
	    ...
	    else if(kind.match('realtime|extensions|statistics|channel_statistics|records|reg_history')) return 'dashboard';
